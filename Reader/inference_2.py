...
def main(args):
    ...
    pcalculator_model_filepath:str=args.pcalculator_model_filepath
    ...
    state_dict=torch.load(pcalculator_model_filepath,map_location=torch.device("cpu"))
...
if __name__=="__main__":
    ...
    parser.add_argument("--pcalculator_model_filepath",type=str)
